    ...
    <div className=" md:px-52 pb-52">
      ...
      <div className="w-full border-black border-2 min-h-[500px]">
        ...
        {dronePartsJson.map((e: any) => (
          <div
            key={e}
            className="border-black border-b-2 min-h-[100px] grid grid-cols-4 items-center"
          >
            <div className="border-black border-r-2 min-h-[100px] flex justify-center items-center">
              <Image
                src={`/drone/droneparts/${e.image}`}
                alt={e.image}
                width={100}
                height={100}
            ...
            <div className="min-h-[100px] flex justify-center items-center">
              {e.link && (
                <Link href={e.link} className="text-blue-700 italic underline">
                  Link
                </Link>
              )}
            </div>
        ...
        <div className="border-black border-b-2 h-[30px] grid grid-cols-2 text-center bg-blue-200">
          <div className="border-black border-r-2 ">
            Number of items:{" "}
            <b className="px-2 text-lg">{dronePartsJson.length}</b>
          </div>
          <div className="border-black border-r-2 ">
            Total price: <b className="px-2 text-lg">{totalPrice()}</b> Euro
          </div>
        </div>
      </div>
    </div>
