  ...
  return (
    <div className="hidden md:block md:mx-5 md:my-2">
        ...
        <div className="z-[999]">
            ...
            <div className=" w-96 bg-white h-80 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-xl z-[999] ">
                <h1 className=" font-serif text-blue-400 text-center relative top-5">Pick the theme color:</h1>
